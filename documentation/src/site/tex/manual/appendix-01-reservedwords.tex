...
\begin{table}[t]
    ...
    \begin{center}
        \begin{tabular}{|l|l|}
            ...
            \hline
            \sodalet $e_{1} \ldots e_{n}$ \sodain $e$                      & expression with bindings $e_{1}, \ldots, e_{n}$ in $e$          \\
            \hline
            ...
            \sodahas $f$                                                   & function or constant $f$ is to be defined                       \\
            \sodathis                                                      & reference to itself as an instance                              \\
            \hline
            \sodapackage $p$                                               & package declaration for this piece of code                      \\
            \sodaimport $p$                                                & import declaration in this piece of code                        \\
            \hline
        \end{tabular}
    \end{center}
\end{table}
