...
\sodaclass\ B (V_{B}) \ \sodaextends\ P_{2} S_{B} \sodaend\ \cup S_{A}
\]
can be rewritten as:
\[\sodaclass\ A (V_{A}) \ \sodaextends\ P_{1}  S_{A} \sodaend\
\]
\[\sodaclass\ AB (V_{A}, V_{B}) \ \sodaextends\ P_{2} (S_{A} \cup S_{B}) \sodaend\
\]
