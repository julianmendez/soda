...
For this reason, it is recommended to use abstract classes as much as possible, and only use empty concrete classes containing trivial constants or functions.
