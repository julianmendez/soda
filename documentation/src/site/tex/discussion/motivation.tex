...
\begin{itemize}
    ...
    \item AI systems can be very complex\footnote{\url{https://builtin.com/artificial-intelligence}}.
...
\footnote{\url{https://www.cser.ac.uk/research/risks-from-artificial-intelligence/}}\footnote{\url{https://futureoflife.org/open-letter-autonomous-weapons/}}.
...
\comment{
    ...
    \begin{itemize}
        \item a very complex system
        \item AI is whatever hasn't been done yet. (Larry Tesler's theorem)
    \end{itemize}
...
\comment{
    ...
    \begin{itemize}
        \item C -> pro: efficient and long running, con: difficult to maintain, code can be unreadable
        \item Python -> pro: fast prototyping, con: you never know where it crashes
        \item Java -> pro: reliable engineering, con: verbose and difficult to read
        \item Scala -> pro: highly flexible and elegant, con: things can be written in a completely illegible way
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Haskell: because it is a long running functional language, with a large community. It is a kind of de-facto standard in functional languages.
        ...
        \item Python: because it is becoming the de-facto standard language in teaching. Many students start with Scratch\footnote{\url{https://scratch.mit.edu/}}, but there is a natural transition to Python. So, in practice many people will understand Python before any other computer language.
    \end{itemize}
}
...
\comment{
    The approach to prove a new better language is possible is similar to Cantor's diagonal argument.
