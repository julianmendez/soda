...
\lstdefinelanguage{Soda}{
    morekeywords={if, then, else, let, in, match, case, end, class, abstract, extends, this, subtype, supertype, false, true, not, and, or, package, import, theorem, proof, is, lambda, @new, @tailrec, @override, @main},
