...
\lstdefinelanguage{Soda}{
    morekeywords={if, then, else, let, in, match, case, class, has, extends, with, this, subtype, supertype, false, true, not, and, or, package, import, is, lambda, @new, @tailrec, @override, @main},
