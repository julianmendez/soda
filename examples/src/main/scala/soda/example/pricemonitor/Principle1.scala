...
trait Report1 {
  ...
  def price_for_c1: Int

  def price_for_c2: Int

  def similarity: Double
}

case class Report1_ (compliant: Boolean, price_for_c1: Int, price_for_c2: Int, similarity: Double )  extends Report1
  ...
  def complies (c1: Customer, c2: Customer, flight: Flight, date_in_days: Int ): Report1 =
    {
      ...
      Report1_ (similarity >= minimum_acceptable_similarity, price_for_c1, price_for_c2, similarity ) }
}
