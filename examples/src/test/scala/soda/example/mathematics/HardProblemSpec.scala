  ...
  test ("hard problem 9")
    {
      ...
      lazy val value = 9
      lazy val expected = (19, Seq ((9, 19 ), (28, 18 ), (14, 17 ), (7, 16 ), (22, 15 ),
  ...
  test ("hard problem 12")
    {
      lazy val instance = HardProblem_ ()
      lazy val value = 12
      lazy val expected = (9, Seq ((12, 9 ), (6, 8 ), (3, 7 ), (10, 6 ), (5, 5 ),
  ...
  test ("hard problem 13")
    {
      lazy val instance = HardProblem_ ()
      lazy val value = 13
      lazy val expected = (9, Seq ((13, 9 ), (40, 8 ), (20, 7 ), (10, 6 ), (5, 5 ),
        (16, 4 ), (8, 3 ), (4, 2 ), (2, 1 ), (1, 0 ) ) .toMap )
      lazy val obtained = instance.compute (value, empty_map )
      assert (obtained == expected ) }
  ...
  test ("hard problem 14")
    {
      lazy val instance = HardProblem_ ()
      lazy val value = 14
      lazy val expected = (17, Seq ((14, 17 ), (7, 16 ), (22, 15 ), (11, 14 ), (34, 13 ), (17, 12 ), (52, 11 ), (26, 10 ),
        (13, 9 ), (40, 8 ), (20, 7 ), (10, 6 ), (5, 5 ), (16, 4 ), (8, 3 ), (4, 2 ), (2, 1 ), (1, 0 ) ) .toMap )
      lazy val obtained = instance.compute (value, empty_map )
      assert (obtained == expected ) }
  ...
  test ("memoized fibonacci 20")
    {
      ...
      lazy val value = 20
      lazy val expected = (6765, Seq ((20, 6765 ), (19, 4181 ), (18, 2584 ), (17, 1597 ), (16, 987 ), (15, 610 ), (14, 377 ),
