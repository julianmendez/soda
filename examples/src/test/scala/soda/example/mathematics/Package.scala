    ...
    org.scalatest.funsuite.AnyFunSuite
{
  ...
  private lazy val _factorial_concise = FactorialConcise .mk

  private lazy val _factorial_simple = FactorialSimple .mk

  private lazy val _factorial_patten_matching = FactorialPatternMatching .mk

  private lazy val _factorial_with_fold = FactorialWithFold .mk
    ...
    org.scalatest.funsuite.AnyFunSuite
{
  ...
  private lazy val _fibo_example_in_soda = FiboExampleInSoda .mk
  ...
  private lazy val _fibo_alternative_example_in_soda = FiboAlternativeExampleInSoda .mk
    ...
    org.scalatest.funsuite.AnyFunSuite
{
  ...
  lazy val instance = HardProblem .mk

  test ("hard problem 9") (
    check (
      obtained = instance.compute (InputPair .mk (9) (empty_map) )
    ) (
      expected = OutputPair .mk (19) (Seq ( (9 , 19) , (28 , 18) , (14 , 17) , (7 , 16) ,
        (22 , 15), (11 , 14) , (34 , 13) ,
  ...
  test ("hard problem 12") (
    check (
      obtained = instance .compute (InputPair .mk (12) (empty_map) )
    ) (
      expected = OutputPair .mk (9) (Seq ( (12 , 9) , (6 , 8) , (3 , 7) , (10 , 6) , (5 , 5),
  ...
  test ("hard problem 13") (
    check (
      obtained = instance .compute (InputPair .mk (13) (empty_map) )
    ) (
      expected = OutputPair .mk (9) (Seq ( (13 , 9) , (40 , 8) , (20 , 7) , (10 , 6) , (5 ,
      5)
      ,
        (16 , 4) , (8 , 3) , (4 , 2) , (2 , 1) , (1 , 0) ) .toMap)
    )
  ...
  test ("hard problem 14") (
    check (
      obtained = instance .compute (InputPair .mk (14) (empty_map) )
    ) (
      expected = OutputPair .mk (17) (Seq ( (14 , 17) , (7 , 16) , (22 , 15) , (11 , 14) ,
  ...
  test ("hard problem 16") (
    check (
      obtained = instance .compute (InputPair .mk (16) (empty_map) )
    ) (
      expected = OutputPair .mk (4) (Seq ( (16 , 4) , (8 , 3) , (4 , 2) , (2 , 1) , (1 , 0) )
        .toMap)
    )
  )
  ...
  test ("hard problem 20") (
    check (
      obtained = instance .compute (InputPair .mk (20) (empty_map) )
    ) (
      expected = OutputPair .mk (7) (Seq ( (20 , 7) , (10 , 6) , (5 , 5) , (16 , 4) , (8 , 3) ,
        (4 , 2) , (2 , 1) , (1 , 0) ) .toMap)
    )
  )
  ...
  test ("memoized fibonacci 20") (
    check (
      obtained = MemoizedFibonacci .mk .compute (InputPair .mk (20) (empty_map) )
    ) (
      expected = OutputPair .mk (6765) (Seq ( (20 , 6765) , (19 , 4181) , (18 , 2584) ,
    ...
    org.scalatest.funsuite.AnyFunSuite
{
  ...
  private lazy val _pi_iterator = PiIterator .mk
