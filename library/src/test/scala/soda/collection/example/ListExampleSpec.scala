...
case class ListExampleSpec () extends org.scalatest.funsuite.AnyFunSuite {
  ...
  test ("should test a") {
    ...
    lazy val obtained = ListExampleImpl () .a_example
  ...
  test ("should test b") {
    ...
    lazy val obtained = ListExampleImpl () .b_example
  ...
  test ("should test a.take") {
    ...
    lazy val obtained = ListExampleImpl () .take_example
  ...
  test ("should test a.takeRight") {
    ...
    lazy val obtained = ListExampleImpl () .takeRight_example
  ...
  test ("should test a.takeWhile") {
    ...
    lazy val obtained = ListExampleImpl () .takeWhile_example
  ...
  test ("should test a.drop") {
    ...
    lazy val obtained = ListExampleImpl () .drop_example
  ...
  test ("should test a.dropRight") {
    ...
    lazy val obtained = ListExampleImpl () .dropRight_example
  ...
  test ("should test a.dropWhile") {
    ...
    lazy val obtained = ListExampleImpl () .dropWhile_example
  ...
  test ("should test a.splitAt") {
    ...
    lazy val obtained = ListExampleImpl () .splitAt_example
  ...
  test ("should test a.indices") {
    ...
    lazy val obtained = ListExampleImpl () .indices_example
  ...
  test ("should test a.zipWithIndex") {
    ...
    lazy val obtained = ListExampleImpl () .zipWithIndex_example
  ...
  test ("should test a.zip") {
    ...
    lazy val obtained = ListExampleImpl () .zip_example
  ...
  test ("should test a.reverse") {
    ...
    lazy val obtained = ListExampleImpl () .reverse_example
  ...
  test ("should test a.+") {
    ...
    lazy val obtained = ListExampleImpl () .prepended_example
  ...
  test ("should test a.:") {
    ...
    lazy val obtained = ListExampleImpl () .appended_example
  ...
  test ("should test a.++") {
    ...
    lazy val obtained = ListExampleImpl () .concat_example
  ...
  test ("should test a.span") {
    ...
    lazy val obtained = ListExampleImpl () .span_example
  ...
  test ("should test a.map") {
    ...
    lazy val obtained = ListExampleImpl () .map_example
  ...
  test ("should test a.filter") {
    ...
    lazy val obtained = ListExampleImpl () .filter_example
  ...
  test ("should test b.fold") {
    ...
    lazy val obtained = ListExampleImpl () .fold_example
  ...
  test ("should test a.foldLeft") {
    ...
    lazy val obtained = ListExampleImpl () .foldLeft_example
  ...
  test ("should test a.foldRight") {
    ...
    lazy val obtained = ListExampleImpl () .foldRight_example
