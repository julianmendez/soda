...
\lstdefinelanguage{Soda}{
    morekeywords={lambda, any, if, then, else, match, case, end, class, extends, abstract, end, this, subtype, supertype, false, true, not, and, or, package, import, theorem, proof, @tailrec, @override, @new},
    sensitive=true,
    morecomment=[s]{/*}{*/},
   morestring=[b]"
}
