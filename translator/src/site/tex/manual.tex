...
\lstdefinelanguage{Scopus}{
    morekeywords={if, then, else, class, has, extends, with, this, false, true, not, and, or, package, import, new, is, in, suchthat, @tailrec, @override, @main},
...
\begin{document}
    ...
    In \Scopus, a protected class, attribute, or method name can be identified by using an underscore as prefix.
