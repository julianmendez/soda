...
\begin{document}
  ...
  * FactorialConcise () extends AbstractFactorialConcise {
  ...
  class FactorialVerbose () extends AbstractFactorialVerbose {
    ...
    \begin{tabular}{ll}
        \hline
        \srccode{x = y}  & function or constant definition \\
        \srccode{x=y}    & give parameter $x$ value $y$    \\
        \srccode{:}      &                                 \\
        \srccode{->}     &                                 \\
        \hline
        \sif             &                                 \\
        ...
        \hline
        \sequalsSign     &                                 \\
        \srccode{x + y}  & addition                        \\
        \srccode{x - y}  & subtraction                     \\
        \srccode{x * y}  & multiplication                  \\
        \srccode{x / y}  & division                        \\
        \srccode{x \% y} & modulo                          \\
        \hline
        \stailrec        &                                 \\
        \soverride       &                                 \\
