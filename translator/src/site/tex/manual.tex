...
morekeywords={if, then, else, class, has, extends, with, this, false, true, not, and, or, package, import, new, @override, @tailrec},
...
\begin{document}
  ...
  plus_one (sequence: Seq[Int]) =
    ...
    \subsubsection{\sclass, \shas, \sasterisk}
  ...
  class Person (name: String)
    ...
    An asterisk (\sasterisk) can be used to replace the \sclass reserved word.
    Thus, the classes above can also be declared as follows:
