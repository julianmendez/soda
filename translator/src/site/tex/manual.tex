...
\begin{document}
  ...
  class GroupName (name: String) {
    ...
    \begin{lstlisting}[label={lst:exampleTailrecOutside}]
  ...
  sum_rec (n: Int, accum: Int): Int =
    ...
    For technical reasons, a function with tail recursion needs to be declared private in classes.
    If they are used inside another function, this declaration is not necessary, since the tail recursive function is automatically private.
