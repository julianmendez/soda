...
As we can see, the auxiliary functions are \textbf{private}, and cannot be tested outside \srccode{relevant_function}.
An alternative, would be to put the auxiliary functions in the class, but outside \srccode{relevant_function}.
...
In this case, \srccode{relevant_function} can use the auxiliary functions in class \srccode{_AuxRF}.
